...
void CMinimiserBrent::_CheckAndSwap (double& rLeft, double& rRight)
{
	if (rRight < rLeft)
	{
...
void CMinimiserBrent::_PerformSearch(double& rLeft, double& rRight)
{
...
void CMinimiserBrent::Optimise (double /*target*/)
{
